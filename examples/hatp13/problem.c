...
int main(int argc, char* argv[]){
  ...
  double mincs[10] = {0.0, 5., 10., 15., 20., 25., 30., 35., 40., 45., 50.};
...
void heartbeat(struct reb_simulation* sim){
    ...
    if(reb_output_check(sim, 100)){        // outputs every 100 years
      ...
      fprintf(of, "%d,%e,%e,%e,%e,%e,%e,%e,%e,%e,%e,%e,%e,%e,%e,%e,%e,%e,%e,%e,%e,%e,%e,%e,%e,%e,%e,%e\n", j_glob,sim->t, Omega_sun->x, Omega_sun->y, Omega_sun->z, mag_p, theta_p, phi_p, a1, e1, i1, n1.x, n1.y, n1.z, Om1, pom1, a2, e2, i2, n2.x, n2.y, n2.z, Om2, pom2, p_ob, pert_ob, mi, k2); // print spins and orbits
