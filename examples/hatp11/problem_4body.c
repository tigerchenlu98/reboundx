...
// Code for 4-body scattering. Used to generate Figure 4 in Lu+ (2024)

double MASSB = 23.4 * 3e-6;
...
int main(int argc, char* argv[]){
    ...
    double smas[3] = {0.3, 8.759, 12.930, 19.086};
    double masses[3] = {MASSB, MASSC, MASSC, MASSC};

    double rad_b = 4.36 * 4.26e-5;
    double rho = 1.33 * pow(1.496e13, 3.) / (1.989e33);
    double rad_c = pow(((3. * MASSC) / (4. * M_PI * rho)), 1./3.);

    double rads[4] = {rad_b, rad_c, rad_c, rad_c};
