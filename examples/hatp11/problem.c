...
char title[100] = "zlk_1112/output_";
char title_stats[100] = "zlk_1112/final_stats";
char title_remove[100] = "rm -v zlk_1112/output_";
int ind;
int printed_stats=1;
...
int main(int argc, char* argv[]){
 ...
 double planet_a = reb_random_uniform(sim, 0.5, 1.0);
 ...
 double planet_inc = reb_random_uniform(sim, 6.0, 39.0) * (M_PI/180.);
 ...
 reb_add_fmt(sim, "m r a e inc Omega omega", planet_m, planet_r, planet_a, planet_e, planet_inc, planet_Omega, planet_omega);
...
void heartbeat(struct reb_simulation* sim){
   ...
   if(reb_output_check(sim, 100 * 2 * M_PI)){        // outputs every 100 years
     ...
     fprintf(of, "%f,%e,%f,%f,%f,%e,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f\n", sim->t,a1,i1,e1,p_ob,a2,i2,e2,pert_ob,mi,mag_p,theta_p,phi_p,n1.x,n1.y,n1.z,n2.x,n2.y,n2.z,Omega_sun->x, Omega_sun->y, Omega_sun->z,Om1,Om2); // print spins and orbits
