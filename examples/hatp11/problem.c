...
int main(int argc, char* argv[]){
 ...
 planet_a = reb_random_uniform(sim, 0.5, 1.5);
 ...
 double perturber_a = reb_random_uniform(sim, 4.192 - 0.072, 4.192 + 0.072);
 double perturber_e = reb_random_uniform(sim, 0.56 - 0.035, 0.56 + 0.035);
 double perturber_m = reb_random_uniform(sim, 3.06 - 0.41, 3.06 + 0.43) * 9.55e-4;
 double perturber_inc = reb_random_uniform(sim, 33.5 - 4.4, 33.5 + 6.1) * M_PI / 180.;
